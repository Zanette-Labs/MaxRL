...
ADVANTAGE_ESTIMATOR=naive_conditional_expectation
...
TRAIN_DATASET_PATH=/u/ftajwar/data_for_logp/dapo/train.parquet
TEST_DATASET_PATH=/u/ftajwar/data_for_logp/srt_test_dataset/test.parquet
...
PROJECT_NAME=log_p_qwen2.5_math_7B_on_math
EXPERIMENT_NAME=naive_conditional_expectation

VALIDATION_DATA_DIR=/u/ftajwar/online_paprika/validation_${EXPERIMENT_NAME}
ROLLOUT_DATA_DIR=/u/ftajwar/online_paprika/training_${EXPERIMENT_NAME}

# path to save checkpoints
CHECKPOINT_SAVE_PATH=/work/nvme/befo/ftajwar/self_labeling_checkpoints/${PROJECT_NAME}/${EXPERIMENT_NAME}
rm -rf $CHECKPOINT_SAVE_PATH

export VLLM_ATTENTION_BACKEND=XFORMERS
export SEED=69

python3 -c "import transformers; transformers.pipeline('text-generation', model='Qwen/Qwen2.5-Math-7B')"
