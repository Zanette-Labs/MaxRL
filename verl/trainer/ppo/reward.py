...
def compute_reward(data: DataProto, reward_fn):
    ...
    try:
        ...
        # Pass through additional metrics from reward manager (e.g., majority voting)
        for additional_key in [
            ...
            "majority_vote_num_prompts_global",
            "majority_vote_num_prompts_per_datasource",
        ]:
            if additional_key in reward_result and reward_result[additional_key] is not None:
                reward_extra_infos_dict[additional_key] = reward_result[additional_key]
